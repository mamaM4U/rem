...
class ProfileView extends GetView<ProfileController> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ElevatedButton(onPressed: controller.loadUserProfile, child: const Text('Retry')),
            ],
          ),
        ),
      );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildModernInfoRow(icon: Icons.person_outline, label: 'Full Name', value: user.name),
                const SizedBox(height: 16),
                _buildModernInfoRow(icon: Icons.email_outlined, label: 'Email Address', value: user.email),
              ],
            ),
          ),
  ...
  Widget _buildModernInfoRow({required IconData icon, required String label, required String value}) {
    return Container(
